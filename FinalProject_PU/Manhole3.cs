...
namespace FinalProject_PU
{
    ...
    [Activity(Label = "Manhole3")]
    public class Manhole3 : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
          ...
          char[] arr = Control.UserInfoHolder.User_name.ToCharArray();
            ...
            circleImageView5.SetImageBitmap(bitmapp);
        ...
        private async void Creatissue5_btnnext_Click(object sender, EventArgs e)
        {
            if (selected != "")
            {
                await Task.Run(() =>
                {
                    ...
                    man.traffic = selected;
                    FinalProject_PU.Control.DataOper.PutData<Manhole4>(this, man);
