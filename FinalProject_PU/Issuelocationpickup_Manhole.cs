...
{
    [Activity(Label = "Issuelocationpickup_DebriManhole")]
    public class Issuelocationpickup_Manhole : Activity, IOnMapReadyCallback, ILocationSourceOnLocationChangedListener
    {
        ...
        private async void Set_location_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var Issue = JsonConvert.DeserializeObject<Model.Manhole>(Intent.GetStringExtra("objtopass"));
                ...
                try
                {
                    ...
                    if (placemark != null)
                    {
                        ...
                        {
                            s_stat = "Spill";
                            Issue.issueStatement = "Manhole" + s_stat+"near" + LocationName;
                            await Control.IssueController.PostIssue<Model.Manhole>(Issue, this);
