...
namespace FinalProject_PU
{
    ...
    public class Issuelocationpickup_MissingVehicle : Activity ,IOnMapReadyCallback, ILocationSourceOnLocationChangedListener
    {
        static string LocationName, s_stat;
