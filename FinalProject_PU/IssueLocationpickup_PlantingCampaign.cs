...
{
    [Activity(Label = "IssueLocationpickup_PlantingCampaign")]
    public class IssueLocationpickup_PlantingCampaign : Activity , IOnMapReadyCallback, ILocationSourceOnLocationChangedListener
    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (placemark != null)
                    {
                        ...
                        p.issueStatement = "Planting Campaign starts from" + p.issueDate.Date + "near" + LocationName;
                        await Control.IssueController.PostIssue<Model.Planting>(p, this);
                    }
                }
