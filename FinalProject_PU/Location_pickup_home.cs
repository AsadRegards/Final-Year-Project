    ...
    public class Location_pickup_home : Activity, IOnMapReadyCallback
    {
        ...
        private void Set_location_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                User.homelocatlati = Final_Position.Latitude.ToString();
                User.homelocatlongi = Final_Position.Longitude.ToString();
                var intent = new Intent(this, typeof(LocationsActivity));
                intent.PutExtra("userObjtoJob", JsonConvert.SerializeObject(User));
